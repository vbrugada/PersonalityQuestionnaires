...
for i_neopif = 1:size(NEOPIfacetsvalues, 2)
    ...
    formatcorrplots ([0.5 7.5], [0.5 85.5], ...
        namefacets(i_neopif), '' , ...
        '', [0, 8], [0, 80], [0, 80], [40, 40], [4, 4], [0, 80]);
...
for i_neopid = 1:size(NEOPIdomainsval, 2)
    ...
    formatcorrplots ([0.5 7.5], [0.5 85.5], ...
        ...
        'NEOPI T-values', [0, 8], [0, 80], [0, 80], [40, 40], [4, 4], [0, 80]);
...
set(fig4,'units','normalized', 'Position', [0.2 0.2 0.45 0.7]);
